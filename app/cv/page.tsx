      ...
      <div id="cv-print-content">
        ...
        <Section title="About">
          <p className="text-muted-foreground">
            Hi! I'm a Junior Full-Stack Developer with a strong focus on Frontend, driven by curiosity and a constant desire to improve.
            I enjoy building clean, engaging, and user-focused web experiences that balance performance with thoughtful design.
            <br /><br />
            Naturally adaptable, I’m comfortable stepping beyond Frontend when the team needs it — always prioritizing collaboration and impact over titles.
            ...
            My goal is simple: help build meaningful digital experiences while growing alongside the team.
          </p>
        </Section>
        ...
        <Section title="Projects">
          <ExperienceItem
            ...
            link="https://dogwarts-website.vercel.app/"
          />
          <ExperienceItem
